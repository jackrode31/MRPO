...
<body>
<a href="formB.php?lang=es">Espa&ntilde;ol</a> / <a href="formB.php?lang=en">Ingl&eacute;s</a> / <a href="formB.php?lang=it">Italian</a>
	
<div class="container">
	<h2><?php echo $contenido[0];?></h2>
	<hr>
<form action="formsend.php?lang=<?php echo $lang;?>" method="post">
